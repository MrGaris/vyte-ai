...
# ——— Авто-ротація ключів ———
# Варіант 1: OPENROUTER_KEYS="key1,key2,key3"
# Варіант 2: OPENROUTER_KEY_1=..., OPENROUTER_KEY_2=..., OPENROUTER_KEY_3=...
# Варіант 3: старий OPENROUTER_API_KEY (fallback)
def _load_keys():
    keys = []
    raw = os.environ.get("OPENROUTER_KEYS", "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,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,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,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")
    if raw:
...
def get_current_key():
    if not OPENROUTER_KEYS:
        raise RuntimeError("Немає жодного OpenRouter ключа! Додай OPENROUTER_KEYS або OPENROUTER_KEY_1")
...
def rotate_key():
    ...
    logging.getLogger(__name__).warning(f"Ротація ключа! Тепер #{_key_index + 1}/{len(OPENROUTER_KEYS)}")
    return True
# ——————————————————————————
...
def ask_openrouter(messages):
    """Запит до OpenRouter з авто-ротацією ключів при 401/403/429."""
    last_error = None
    attempted = set()
    ...
    while True:
        ...
        if key_id in attempted:
            raise last_error or RuntimeError("Всі ключі вичерпані або заблоковані")
