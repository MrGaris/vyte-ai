...
def main():
    ...
    image_conv = ConversationHandler(
        ...
        fallbacks=[
            ...
            MessageHandler(filters.Regex("^(💬 Новий чат|📋 Історія чатів|⚙️ Налаштування|📊 Аналіз фото|🌐 Переклад|🔗 Стаття з сайту|⏰ Нагадування|🎨 Згенерувати зображення)$"), handle_message),
        ],
    )
